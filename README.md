...
`6.0.0-beta.21`. MapLibre (`6.29.0`) arrives through the map package and must not
...
has the dSYMs for the pinned versions (SDK 6.0.0-beta.44, map 6.0.0-beta.21) from
